...
#include <math.h>
#include "gfx.h"
// cc 8-Way_Recursive_Method_floodfill.c gfx.c -o 8-Way_Recursive_Method_floodfill -I/usr/X11R6/include -L/usr/X11R6/lib -lX11 -lm
...
{ // Basic 8 Way Recursive Method
    if (GetPix(x, y) == replaceable_color_0) //
    {
        ...
        m_flood_fill(x - A, y + A, fill_color, wall_color, replaceable_color_0); //
        m_flood_fill(x + A, y - A, fill_color, wall_color, replaceable_color_0); //
        m_flood_fill(x + A, y + A, fill_color, wall_color, replaceable_color_0); //
        m_flood_fill(x - A, y - A, fill_color, wall_color, replaceable_color_0); //    
